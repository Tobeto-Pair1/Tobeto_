...
{
    /// <inheritdoc />
    public partial class InitializeMigaration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AsyncLessonDetails",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ManufacturerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AsyncLessonId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LessonLanguageId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AsyncLessonDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AsyncLessonDetails_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AsyncLessonDetails_LessonLanguage_LessonLanguageId",
                        column: x => x.LessonLanguageId,
                        principalTable: "LessonLanguage",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AsyncLessonDetails_Manufacturer_ManufacturerId",
                        column: x => x.ManufacturerId,
                        principalTable: "Manufacturer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AsyncLessonDetails_SubTypes_SubTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserLanguages_ForeignLanguageLevels_LanguageLevelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AsyncLessonDetailId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AsyncLessons_AsyncLessonDetails_AsyncLessonDetailId",
                        column: x => x.AsyncLessonDetailId,
                        principalTable: "AsyncLessonDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AsyncLessons_CourseModules_CourseModuleId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("14b5aed1-2aca-4e12-8862-074c43f05958"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Mobil Geliştirme", null, null },
                    { new Guid("2b53fd82-ab26-4a74-984b-7f2e776260e2"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Web Yazılım", null, null },
                    { new Guid("36f53c33-7edc-4b15-85b3-80bf16bb5a0a"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Siber Güvenlik", null, null },
                    { new Guid("d7b9a1ff-f358-461d-bcaa-f4b9afbbee8a"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Gömülü Yazılım", null, null },
                    { new Guid("f1c52867-30a0-4e83-b542-175bc2077c8a"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Soft Skill Eğitim", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AsyncLessonDetails_CategoryId",
                table: "AsyncLessonDetails",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AsyncLessonDetails_LessonLanguageId",
                table: "AsyncLessonDetails",
                column: "LessonLanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_AsyncLessonDetails_ManufacturerId",
                table: "AsyncLessonDetails",
                column: "ManufacturerId");

            migrationBuilder.CreateIndex(
                name: "IX_AsyncLessonDetails_SubTypeId",
                table: "AsyncLessonDetails",
                column: "SubTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_AsyncLessons_AsyncLessonDetailId",
                table: "AsyncLessons",
                column: "AsyncLessonDetailId",
                unique: true);
